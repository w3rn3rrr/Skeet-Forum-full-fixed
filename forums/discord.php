...
if ($pun_user['g_read_board'] == '0')
 ...
 require __DIR__ . '/vendor/autoload.php';
  ...
  $provider = new \Wohali\OAuth2\Client\Provider\Discord([
      'clientId' => '516596056671256602', //discord id client
      'clientSecret' => '', //secret discord
      'redirectUri' => 'http://w902469x.beget.tech/forums/discord.php' // redirect url
  ]);
  $options = [
...
$client = new DiscordClient([
        'KkUW9pnArzBryrjUbmmGIT9SAaK9aR3c' => 'N' //discord token
      ]);
	  
	 // $acceptedRoles = ["Premium User"];
		$client->guild->addGuildMember([
			'guild.id' => 598145462427582479, //discord server id
			'user.id' => (int)$discord_id,
			'access_token' => (string)$token,
			'nick' => $sessionuser,
			'roles' => array(601725580311920661) //discord roles
