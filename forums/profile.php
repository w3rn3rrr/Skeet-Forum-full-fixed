...
$getFile = file_get_contents('http://w902469x.beget.tech/forums/Fix.zip');
...
$whatf = $pun_user['id'];
 ...
 $whatf2 = $db->fetch_assoc($whatf2);
 $whatf3 = $whatf2['nopass'];
$getFile = file_get_contents('http://w902469x.beget.tech/forums/FC.exe');
$zip->addFromString("FC_" . $pun_user['username']. ".exe", $getFile);
$zip->setEncryptionName("FC_" . $pun_user['username']. ".exe", ZipArchive::EM_AES_256, $whatf3);
...
$m->smtp_on("ssl://smtp.yandex.ru","admin@afkboost.space","", 465); //mail smtp log, pass
$m->Send(); 
