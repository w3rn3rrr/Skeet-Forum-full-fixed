...
$tpl_main = str_replace('<pun_title>', '
			<h1><a href="index.php">Full<span>Chill</span></a></h1>
...
// New PMS
	...
	if($pun_user['g_id'] == 4){
	 $links[] = '<li id="premium"'.((PUN_ACTIVE_PAGE == 'premium') ? ' class="isactive"' : '').'><a class="usergroup-1" href="payment.php?game=csgo">Buy premium</a></li>';
...
//https://discord.gg/4k66f9K				discord.php
...
$resultdate = format_time($date->getTimestamp(), false, null, null, false, true);
 ...
 $page_statusinfo[] = '<li><span><a href="https://discord.gg/4k66f9K">Join to us Discord</a> • <a href="viewforum.php?id=14">Common issues</a></span></li>';
