<head>
<title>Payments / FullChill</title>
</head>
<?php
...
// $email = $_POST['email']; //get input text
 ...
 if($plan == 30){
	 $fu = $pun_user['email'];
	redirect("https://www.oplata.info/asp2/pay_wm.asp?id_d=2691360", "Redirecting to the payment system");
...
<div id="brdmain">
<div class="blockform">
	<h2><span>Extend premium</span></h2>
	<div class="box">
								...
								<tr>
									...
									<td>
										<select id="payment_type" name="payment_type" style="width:197px">
											<option value="BankCard">oplata.info</option>
										</select>
									</td>
								</tr>
								<tr>
								...
								<tr>
									...
									<td>
										<select name="plan" style="width:197px">
											<option value="30">30 days - $5.00</option>
